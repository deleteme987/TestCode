...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CanvasPicker_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CanvasPicker_t qt_meta_stringdata_CanvasPicker = {
    {
QT_MOC_LITERAL(0, 0, 12) // "CanvasPicker"
...
const QMetaObject CanvasPicker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CanvasPicker.data,
      qt_meta_data_CanvasPicker,  qt_static_metacall, nullptr, nullptr}
};
...
void *CanvasPicker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CanvasPicker.stringdata0))
